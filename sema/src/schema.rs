...
use online_dsl_forge_parser::{AstExpression, BinaryOp, UnaryOp};
use serde::{Deserialize, Serialize};

use crate::profile::{BodyAccess, BodyTarget, Phase};
...
impl Ord for CapabilityTicket {
    fn cmp(&self, other: &Self) -> std::cmp::Ordering {
        (self.kind_order(), &self.name, self.arity).cmp(&(
            other.kind_order(),
            &other.name,
            other.arity,
        ))
...
impl RuntimeSchema {
    ...
    pub fn waf() -> Self {
        ...
        schema
            ...
            .add_method_capability(
                CapabilityMeta::method("containsBytes", 1)
