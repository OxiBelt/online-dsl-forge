...
use online_dsl_forge_parser::{AstExpression, ExprKind, SourceSpan};

use crate::profile::{BodyNeedSummary, BodyTarget};
use crate::schema::CapabilityKind;
use crate::verified::VerifiedExpression;
...
pub(super) fn member_origin(receiver: ObjectOrigin, field: &str) -> Option<ObjectOrigin> {
    match (receiver, field) {
        ...
        (ObjectOrigin::Request | ObjectOrigin::RequestHttp, "Body") => {
            Some(ObjectOrigin::RequestBody)
        }
